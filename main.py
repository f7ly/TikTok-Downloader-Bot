...
load_dotenv()
bot_token = os.environ.get('7791988103:AAErhJ6pfaru917k9d4yxnBr3wc49s1152k')
workers = int(os.environ.get('WORKERS'))
api = int(os.environ.get('21962139'))
hash = os.environ.get('2022764389f217b569a09f30112415c8')
